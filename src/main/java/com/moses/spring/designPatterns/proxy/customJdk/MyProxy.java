...
public class MyProxy {
	...
	private static String generateSource(Class<?> interfaces) {
		StringBuffer src = new StringBuffer("package com.moses.spring.proxy.customJdk;").append(ln);
		src.append("import java.lang.reflect.Method;").append(ln);
		src.append("public class $Proxy0 extends MyProxy implements ").append(interfaces.getName()).append("{").append(ln);
