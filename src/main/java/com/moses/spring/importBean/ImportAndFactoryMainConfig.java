package com.moses.spring.importBean;
...
import com.moses.spring.importBean.bean.Cat;
import com.moses.spring.importBean.bean.Dog;
import com.moses.spring.importBean.customImpl.CustomFactoryBean;
import com.moses.spring.importBean.customImpl.CustomImportBeanDefinitionRegistrar;
import com.moses.spring.importBean.customImpl.CustomImportSelector;

@Configuration
@Import(value = {Cat.class, Dog.class, CustomImportSelector.class, CustomImportBeanDefinitionRegistrar.class})
public class ImportAndFactoryMainConfig {
	/*
	 * 给容器中注册组件的方式
